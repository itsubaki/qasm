...
`
	...
	// FIXME: panic: runtime error: index out of range [2] with length 2
	// evaluator.go:759
}
...
`
	...
	// FIXME: panic: runtime error: slice bounds out of range [:4] with capacity 2
	// evaluator.go:545
}
...
`
	...
	// FIXME: [11 10][  3   2]( 1.0000 0.0000i): 1.0000
}
