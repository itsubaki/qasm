...
lex:
	...
	go run main.go lex -f testdata/gate_shor.qasm
...
parse:
	...
	go run main.go parse -f testdata/gate_shor.qasm
...
testdata:
	...
	go run main.go -f testdata/gate_bell.qasm
	go run main.go -f testdata/gate_shor.qasm
